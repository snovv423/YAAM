...
-- ---------------------------------------------------------------------------
-- Аддитивные части ТЕКУЩЕЙ схемы, не относящиеся к миграции статусов выплат
...
-- порядок ровно для тех объектов, которые нужны сервисному слою, создающему
-- фикстурные данные: снимки юр.данных в строках расчёта и реквизиты YAAM.
-- ---------------------------------------------------------------------------
