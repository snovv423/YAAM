...
//
// YAAM HQ Stage 5B: единственное легитимное исключение — img-src должен
// уметь показывать фотографии ресторанов/блюд, которые физически хранятся
// НЕ на этом origin (S3-совместимое хранилище/CDN-домен, задание, раздел 4).
...
module.exports = { createHqSecurityHeaders };
