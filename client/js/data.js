...
const M_KAVKAZ=[
 ...
 {cat:'Напитки',items:[
  // available:false — тем же полем, что приходит из API (is_available), а не
  // позицией в меню: раньше пример недоступного блюда задавался константой
  // SOLD_OUT={'2_0':true} в app.js, и на реальных данных она гасила живое
  // блюдо, стоявшее на этой позиции.
  {n:'Чай горный',d:'Травяной сбор, чайник',p:180,g:G.green,im:P.coffee,available:false},
