...
3. **ЮKassa** — получить реквизиты, реализовать `YookassaProvider` (маркетплейс-схема со сплитом 7%/93%, см. комментарий в файле), протестировать реальные платежи и вебхуки.
